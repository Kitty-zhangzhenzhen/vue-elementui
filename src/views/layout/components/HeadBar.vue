<template>
    <div class="container_headerBar" :class="
    ...
    ">
        ...
        <span class="navbar">
            ...
            <el-menu :default-active="activeIndex" class="el-menu-demo" background-color="#293348" text-color="#bdbec1"
                active-text-color="#ffffff" mode="horizontal" @select="selectNavBar">
